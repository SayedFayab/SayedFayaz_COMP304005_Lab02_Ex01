...
class FurnitureActivity : AppCompatActivity() {
    ...
    var bed:CheckBox? = null
    var sofa:CheckBox? = null
    var cabinet:CheckBox? = null
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_furniture)

        bed = findViewById<CheckBox>(R.id.checkBoxBed)
        sofa = findViewById<CheckBox>(R.id.checkBoxSofa)
        cabinet = findViewById<CheckBox>(R.id.checkBoxCabi)
    ...
    fun check(view: View?) { //saving information from checkboxes to further process on checkout page
        ...
        val bedState = bed!!.isChecked
        val sofaState = sofa!!.isChecked
        val cabinetState = cabinet!!.isChecked
        preferenceEditor.putBoolean("bedState", bedState)
        preferenceEditor.putString("bedName", bed!!.text as String?)
        preferenceEditor.putBoolean("sofaState", sofaState)
        preferenceEditor.putString("sofaName", sofa!!.text as String?)
        preferenceEditor.putBoolean("cabinetState", cabinetState)
        preferenceEditor.putString("cabinetName", cabinet!!.text as String?)
